...
func DefaultFactoryWithAthena(logger logging.Logger, sF sd.SubscriberFactory) defaultFactory {
	return NewDefaultFactoryWithDf(httpProxy, logger, sF)
}
...
func NewDefaultFactoryWithDf(backendFactory BackendFactory, logger logging.Logger, sF sd.SubscriberFactory) defaultFactory {
...
func NewFactoryWithdfFactory(df defaultFactory) Factory {
	return df
}
